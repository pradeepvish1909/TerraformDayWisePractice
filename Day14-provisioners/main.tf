...
resource "aws_key_pair" "example" {
  key_name   = "task"
  public_key = file("C:/Users/pradevis/.ssh/id_ed25519.pub")
}
...
resource "aws_instance" "server" {
  ami                         = "ami-0bdc7d025135d7b49" # Ubuntu AMI
...
#     private_key = file("C:/Users/pradevis/.ssh/id_ed25519")             # Path to private key
#     host        = self.public_ip
#     timeout     = "5m"
#   }
...
#       "echo 'hello from veera nareshit Again' >> /home/ec2-user/file200"
#     ]
#   }
...
resource "null_resource" "run_script" {
  provisioner "remote-exec" {
    connection {
      ...
      user        = "ec2-user"
      private_key = file("C:/Users/pradevis/.ssh/id_ed25519")
    }

    inline = [
      "echo 'hello from veera nareshit Again2.0' >> /home/ec2-user/file200"
    ]
  }
